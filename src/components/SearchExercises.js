  ...
  return (
    ...
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px" >
      ...
      <Box position='relative' mb='72px' >
        ...
        <TextField sx={{
          input: { fontweight: '700', border: 'none', borderRadius: '4px' }, width: { lg: '800px', xs: '350px' }, backgroundColor: '#ff', borderRadius: '40px'
        }}
      ...
      <Box sx={{position:'relative' , width:'1000px' , p:'30px'}} >
